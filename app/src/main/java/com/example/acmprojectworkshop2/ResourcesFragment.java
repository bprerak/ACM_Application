package com.example.acmprojectworkshop2;
...
public class ResourcesFragment extends Fragment {
    ...
    private com.example.acm_demo.fragment.recyclerview.RecyclerHackathons recyclerAdapter;
    ...
    public void LoadJson(final ViewGroup container){
        ...
        call.enqueue(new Callback<List<Event>>() {
            ...
            public void onResponse(Call<List<Event>> call, Response<List<Event>> response) {
                ...
                recyclerAdapter = new com.example.acm_demo.fragment.recyclerview.RecyclerHackathons(hackathons, container.getContext());
